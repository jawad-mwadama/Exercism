...
export function remainingMinutesInOven(actualMinutesInOven) {
 const timeRemaining = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven
...
export function preparationTimeInMinutes(numberOfLayers) {
  const prepTime = PREPARATION_MINUTES_PER_LAYER * numberOfLayers
  return prepTime
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  const prepTime = PREPARATION_MINUTES_PER_LAYER * numberOfLayers
  const totalTime= actualMinutesInOven + prepTime
  return totalTime
}
